...
from app.routes import api_cashiers, api_kitchen_screens, api_meta, api_orders, api_stock, api_printers, api_products, api_stats, pages
...
app.include_router(api_kitchen_screens.router)
